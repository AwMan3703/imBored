...
class GenerateState extends FlxState
{
	...
	override public function create():Void
	{
		...
		// Setup UI
		var gutter:Int = 10;
		add(new BackButton(gutter, gutter, "back", GenerateState));
		add(new FlxButton(gutter * 2 + 80, gutter, "Generate (G)", generateMap));
		add(new FlxButton(gutter * 3 + 160, gutter, "Play (Space)", play));
